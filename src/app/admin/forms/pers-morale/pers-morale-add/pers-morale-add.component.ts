...
@Component({
  selector: 'app-pers-morale-add',
  templateUrl: './pers-morale-add.component.html',
  styleUrls: ['./pers-morale-add.component.scss']
})
export class PersMoraleAddComponent implements OnInit {
